      ...
      <div className="flex justify-center">
        <div className="w-[400px] bg-white rounded-md mt-20">
          ...
          <form className="p-6">
            ...
            <div className="flex justify-center">
              <button
                className="login-btn flex items-center gap-2 justify-center"
                type="button"
                onClick={handleSubmit}
              >
                Sign Up {loading && <Spinner color="teal.500" />}
              </button>
            </div>
          </form>

          {error && (
            <div className="mt-2 text-red-500 p-3 flex gap-3 uppercase bg-red-200">
              <p>{error}</p>
            </div>
          )}
          ...
          <div className=" text-black p-3 flex gap-3">
            ...
            <p className="text-[#ebb961] font-bold">Sign In</p>
          </div>
        </div>
      </div>
    </div>
